...
* [**`standard_functions`**](standard-aliases/standard_functions), containing Bash functions with long descriptive names. It is located in projects directory.

* Users [**`.standardrc`**](standard-aliases/standard_rc) configuration file, specifying short names for functions. It also defines [**options**](standard-aliases/standard_rc#L323-L346) that functions use when they call specific commands. It is located in user's home directory.
